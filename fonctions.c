...

{
    ...
    m->animation.spriteSheet = IMG_Load("images/fire.png");



    m->animation.frames = 8;
    ...
    for (i = 0, w = 0; i < m->animation.frames; i++, w += 185)

    {

        m->animation.Clips[i].w = 86;
